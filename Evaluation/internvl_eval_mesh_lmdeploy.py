...
def parse_args():
    ...
    parser.add_argument("--tp_size", type=int, help="Number of gpu used in tensor parallel", default=1)
...
if __name__ == "__main__":
    ...
    # Load the model
    pipe = pipeline(args.model_path, backend_config=TurbomindEngineConfig(session_len=32768, tp=args.tp_size), log_level = 'WARNING', torch_dtype=torch.bfloat16, low_cpu_mem_usage=True, use_flash_attn=True,)
    ...
    for batch in tqdm(data_loader):
        ...
        visions = [load_image(vision) for vision in visions]
        #print(len(visions))
        #print(prompts)
        #print(labels)
        #print(answers)
